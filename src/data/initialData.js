export const CATEGORIES = [
  { id: 'פתיחה',           label: '🎬 פתיחה' },
  { id: 'היקשרות',         label: '🔷 מהי היקשרות?' },
  { id: 'מיפוי',           label: '🔶 למה אני מרגישה ככה?' },
  { id: 'גוף',             label: '🧬 הגוף וחרדה' },
  { id: 'לופ',             label: '🔁 הלופ שלי' },
  { id: 'מציאות',          label: '🔍 מציאות מול חרדה' },
  { id: 'ציפיות',          label: '🎯 ציפיות וצרכים' },
  { id: 'דינמיקה',         label: '💫 דינמיקת חרדה-נמנע' },
  { id: 'תקשורת',          label: '💬 תקשורת זוגית' },
  { id: 'חברות',           label: '👭 חברות ומשפחה' },
  { id: 'פצעים',           label: '💛 פצעי הליבה' },
  { id: 'סליחה',           label: '🕊️ סליחה, בושה ואשמה' },
  { id: 'קולות',           label: '🎙️ הקולות שבתוכנו' },
  { id: 'ביקורת',          label: '🗣️ הקול הביקורתי' },
  { id: 'ביטחון',          label: '🌿 מה זה להרגיש בטוחה' },
  { id: 'מיניות',          label: '💗 מיניות וקרבה פיזית' },
  { id: 'שינוי',           label: '🤝 אני משתנה והוא נשאר' },
  { id: 'התקדמות',         label: '📈 סימני התקדמות' },
  { id: 'ציר',             label: '⏳ ציר הזמן' },
  { id: 'ילדה',            label: '👧 ילדה פנימית' },
  { id: 'הורה-בוגר-ילד',  label: '🔺 הורה-בוגר-ילד' },
  { id: 'אנרגיות',         label: '☯️ אנרגיות נשיות-זכריות' },
  { id: 'תדרים',           label: '🌊 תדרים' },
  { id: 'ריצוי',           label: '🤲 ריצוי' },
  { id: 'עולם-פנימי',      label: '🏡 העולם הפנימי שלי' },
  { id: 'עצמי',            label: '🌱 בניית עצמי' },
];
